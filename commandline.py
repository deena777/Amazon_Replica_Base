        ...
        if success==True:
            ...
            while True:
                ...
                if in1==1:
                    ...
                    print("Enter Product ID: ")
                    prd_id=input()
                    print("Enter Detail to be udpdated (Created By/Product ID/Product Name/Manufacturer Name/Price/Discount/Total Stock Available) :  ")
                    detail_tbu=input()
        ...
        if success==True:
            ...
            while True:
                ...
                if in3==1:
                    ...
                    print("Enter Detail to be updated (Full Name/Address/Email/Password): ")
                    dtl_tbu=input()
